document.addEventListener('DOMContentLoaded', () => {
    ...
    const sidebarLinks = document.querySelectorAll('.nav-section-link');
    ...
    function updateProgress() {
        ...
        for (let s = 0; s < totalSections; s++) {
            ...
            // Sidebar badge
            const sidebarBadge = document.getElementById(`sidebarBadge${s}`);
            if (sidebarBadge) {
                sidebarBadge.textContent = `${sCompleted}/${sectionCounts[s]}`;
            }
        }
